...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        b1 = Button(
            ...
            cursor="hand2",
            command=lambda: self.StudentWindow_fn(Student),
        )  # cursor hand changes cursor over button
        ...
        # Detect Face Button
        img5 = Image.open(
            os.path.dirname(os.path.realpath(__file__)) + "/img/face_detector1.jpg"
        )
        ...
        b1 = Button(
            ...
            cursor="hand2",
            command=lambda: self.AttendanceWindow_fn(Attendance),
        )
        ...
        # Exit
        img11 = Image.open(
            os.path.dirname(os.path.realpath(__file__)) + "/img/exit.jpg"
        )
        img11 = img11.resize((300, 230), Image.LANCZOS)
        self.photoimg11 = ImageTk.PhotoImage(img11)

        b1 = Button(
            bg_img, image=self.photoimg11, cursor="hand2", command=self.root.quit
        )
