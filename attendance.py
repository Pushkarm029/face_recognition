...
class Attendance:
    def __init__(self, root):
        ...
        # Image 1
        img = PIL.Image.open(
            os.path.dirname(os.path.realpath(__file__)) + "/img/university.jpg"
        )
        img = img.resize(
            (800, 200), PIL.Image.LANCZOS
        ...
        # Image 2
        img1 = PIL.Image.open(
            os.path.dirname(os.path.realpath(__file__)) + "/img/face.jpg"
        )
        img1 = img1.resize(
            (800, 200), PIL.Image.LANCZOS
        )  # ANTIALIAS converts high level img to low level
        ...
        # background image
        img3 = PIL.Image.open(
            os.path.dirname(os.path.realpath(__file__)) + "/img/pink.jpg"
        )
        img3 = img3.resize(
        ...
        img_left = PIL.Image.open(
            os.path.dirname(os.path.realpath(__file__)) + "/img/princeton.jpg"
        )
        ...
        self.atten_studentid = ttk.Entry(
            left_inside_frame, width=22
        )  # ,font=("times new roman",13,"bold")) #entry box for typing
        ...
        self.AttendanceReportTable = ttk.Treeview(
            table_frame,
            column=("id", "roll", "name", "department", "date", "time", "attendance"),
